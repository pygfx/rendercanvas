...
load_library("AppKit")
# load_framework(
#     ctypes.util.find_library("MetalKit"),
#     framework_name="MetalKit"
#     )
...
class CocoaRenderCanvas(BaseRenderCanvas):
    ...
    def __init__(self, *args, **kwargs):
        ...
        rect = NSRect(NSPoint(100, 100), NSSize(100, 100))
    ...
    def _keep_notified_of_resizes(self):
        ...
        self._delegate1 = WindowDelegate.alloc().init()
        self._delegate2 = self._window.setDelegate_(self._delegate1)
        update_size()
    ...
    def _rc_request_draw(self):
        # For this backend there's no need to wait (a direct call is allowed).
        self._time_to_draw()

    def _rc_request_paint(self):
        # Schedule a new paint (a direct call is not allowed).
        loop = self._rc_canvas_group.get_loop()
        loop.call_soon(self._paint)

    def _rc_force_paint(self):
        self._paint()
        app.updateWindows()  # does not work?
